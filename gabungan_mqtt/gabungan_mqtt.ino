...
void mqtt_callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (String(topic) == topic_control) {
    ...
    if (message.indexOf("\"direction\":\"forward\"") > 0) currentDirection = "forward";
    else if (message.indexOf("\"direction\":\"reverse\"") > 0) currentDirection = "reverse";
    else if (message.indexOf("\"direction\":\"stop\"") > 0) currentDirection = "stop";
  }
